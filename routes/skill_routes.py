...
def create_skill():
    ...
    result, status_code = SkillController.create_skill(user_id, data)
...
def get_skills():
    ...
    result, status_code = SkillController.get_user_skills(user_id)
    return jsonify(result), status_code
...
def get_skill_detail(skill_id):
    ...
    result, status_code = SkillController.get_skill_detail(user_id, skill_id)
    return jsonify(result), status_code
...
def update_subtopic_status(subtopic_id):
    ...
    result, status_code = SkillController.update_subtopic_status(
        user_id, subtopic_id, data.get('status')
    )
    return jsonify(result), status_code
